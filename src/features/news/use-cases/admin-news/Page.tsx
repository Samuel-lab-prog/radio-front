    ...
    <main className="mx-auto w-[calc(100%-2rem)] max-w-[940px] pb-24 pt-16">
      ...
      >
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-3 text-sm font-black transition ${panelMode === 'create' ? 'bg-white text-[#10213b] shadow-sm' : 'text-[#617a9d] hover:text-[#223a59]'}`}
          onClick={startCreate}
          role="tab"
          type="button"
        >
        ...
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-3 text-sm font-black transition ${panelMode === 'edit' ? 'bg-white text-[#10213b] shadow-sm' : 'text-[#617a9d] hover:text-[#223a59]'}`}
        ...
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-3 text-sm font-black transition ${panelMode === 'delete' ? 'bg-white text-[#10213b] shadow-sm' : 'text-[#617a9d] hover:text-[#223a59]'}`}
