      ...
      <section className="relative mx-auto grid w-[calc(100%-2rem)] max-w-[1120px] items-center gap-12 pb-20 pt-16 lg:grid-cols-[0.94fr_1.06fr] lg:gap-20 lg:pb-28 lg:pt-24">
        <div className="relative z-[1]">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              className="inline-flex items-center gap-2 rounded-[10px] bg-[#f0645d] px-5 py-3.5 font-extrabold text-white shadow-[0_10px_20px_rgb(240_100_93_/_18%)] transition-transform hover:-translate-y-0.5"
              href="#live"
            >
              <Headphones size={17} /> Ouça agora
            </a>
            <Link
              className="inline-flex items-center gap-2 rounded-[10px] px-4 py-3.5 font-extrabold text-[#10213b] transition-colors hover:text-[#f0645d]"
              to="/news"
            >
        ...
        <div className="relative min-h-[390px] lg:min-h-[455px]">
          ...
          <div className="absolute bottom-[13%] left-[12%] max-w-[210px] rounded-2xl bg-white px-5 py-4 text-[#10213b] shadow-[0_14px_25px_rgb(7_17_32_/_18%)] sm:bottom-[14%] sm:left-[18%]">
            ...
            <strong className="block text-lg leading-tight">Gaivota FM</strong>
        ...
        <div className="mx-auto grid w-[calc(100%-2rem)] max-w-[1120px] gap-10 py-16 lg:grid-cols-[0.78fr_1.22fr] lg:gap-24 lg:py-24">
          ...
          <div className="grid gap-5 text-[1.05rem] leading-[1.8] text-[#617a9d]">
            <p>
              ...
              som que toca no fundo. Ela pode informar sem afastar, divertir sem
              distrair e criar um ponto de encontro para quem vive a mesma
              cidade.
            </p>
            <p>
              Por isso, nossa programação mistura a trilha sonora dos seus dias
              com as notícias, os eventos e as vozes que fazem parte da nossa
              comunidade. Tudo com leveza, presença e aquele jeito bom de
              conversar de perto.
            </p>
