    ...
    <main className="mx-auto w-[calc(100%-2rem)] max-w-[940px] pb-24 pt-16">
      <section className="rounded-2xl border border-[#e1e7ef] bg-white p-6 shadow-[0_10px_25px_rgb(16_33_59_/_4%)]">
        ...
        <form className="grid gap-4" onSubmit={submit}>
          ...
          <button
            className="inline-flex items-center justify-center gap-2 rounded-[10px] border-0 bg-[#f0645d] px-[1.15rem] py-3.5 font-extrabold text-white shadow-[0_10px_20px_rgb(240_100_93_/_18%)]"
            type="submit"
          >
            Entrar
          </button>
