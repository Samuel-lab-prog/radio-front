    ...
    <main>
      <section className="mx-auto grid w-[calc(100%-2rem)] max-w-[1120px] grid-cols-1 items-center gap-10 py-16 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20 lg:py-20">
        <div>
          ...
          <button
            aria-label={
              isPlaying ? 'Transmissão em reprodução' : 'Reproduzir transmissão'
            }
            className="mt-5 inline-flex items-center gap-2 rounded-[10px] bg-[#f0645d] px-[1.15rem] py-3.5 font-extrabold text-white shadow-[0_10px_20px_rgb(240_100_93_/_18%)]"
            disabled={isLoading}
            onClick={() => void play()}
            type="button"
          >
